...
export const autolinkConfig: Options = {
	properties: { class: 'anchor-link', style: "margin-top: 30px; margin-left: 10px"},
	behavior: 'after',
	group: ({ tagName }) => h('div', { tabIndex: -1, class: `flex items-center heading-wrapper level-${tagName}` }),
